...
//         const endpoint = activeTab === "salesman" ? "salesman" : "manager";
...
//         {/* Header */}
//         <div className="mb-8">
//           <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Commission & Target Settings</h2>
//           <p className="text-gray-600 dark:text-gray-400">Configure all commission settings for your team</p>
//         </div>

//         {/* Tabs */}
//         <div className="flex border-b border-gray-200 dark:border-gray-700 mb-6">
//           <button
//             className={`py-2 px-4 font-medium text-sm flex items-center ${activeTab === "salesman" ? "text-indigo-600 dark:text-indigo-400 border-b-2 border-indigo-500" : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300"}`}
//             onClick={() => setActiveTab("salesman")}
//           >
//             Salesman Settings
//           </button>
//           <button
//             className={`py-2 px-4 font-medium text-sm flex items-center ${activeTab === "manager" ? "text-indigo-600 dark:text-indigo-400 border-b-2 border-indigo-500" : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300"}`}
...
//                 <p className="text-sm text-gray-500 dark:text-gray-400">Sales Commission</p>
//                 <p className="text-lg font-semibold text-gray-900 dark:text-white">
//                   {formatCurrency(activeTab === "salesman" ? currentSettings.salesmanCommission : currentSettings.managerCommission)}
//                 </p>
//               </div>
//               <div className="bg-white dark:bg-gray-700 p-3 rounded-lg shadow-sm">
//                 <p className="text-sm text-gray-500 dark:text-gray-400">Sales Target</p>
//                 <p className="text-lg font-semibold text-gray-900 dark:text-white">
//                   {formatCurrency(currentSettings.salesTarget)}
//                 </p>
//               </div>
//               <div className="bg-white dark:bg-gray-700 p-3 rounded-lg shadow-sm">
//                 <p className="text-sm text-gray-500 dark:text-gray-400">Subscription Commission</p>
//                 <p className="text-lg font-semibold text-gray-900 dark:text-white">
...
//             <span className="ml-2 text-gray-500 dark:text-gray-400">Loading current settings...</span>
//           </div>
//         )}
...
//             {/* Sales Target */}
//             <div>
//               <label htmlFor="salesTarget" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
...
//                 (loading || (!formData.salesCommission && !formData.salesTarget && !formData.subscriptionCommission)) 
...
//   const currentSettings = activeTab === 'salesman' ? salesman.settings : manager.settings;
//   const loadingStatus = activeTab === 'salesman' ? salesman.status : manager.status;
...
//     if (!formData.salesCommission && !formData.salesTarget && !formData.subscriptionCommission) {
//       dispatch(setMessage({
...
//     dispatch(updateCommissionSettings({
//       role: activeTab,
//       settings: formData
//     }));
...
//             Failed to load settings: {activeTab === 'salesman' ? salesman.error : manager.error}
//           </div>
//         ) : currentSettings ? (
//           <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mb-6">
//             <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Current Settings</h3>
...
//             <button
//               type="submit"
//               disabled={updateStatus === 'loading' || (!formData.salesCommission && !formData.salesTarget && !formData.subscriptionCommission)}
//               className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${
//                 (updateStatus === 'loading' || (!formData.salesCommission && !formData.salesTarget && !formData.subscriptionCommission)) 
//                 ? 'opacity-50 cursor-not-allowed' 
//                 : ''
//               }`}
//             >
...
const CommissionSettings = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.salesCommission && !formData.salesTarget && 
        !formData.subscriptionCommission && !formData.salesmanSalesCommissionForManager) {
      dispatch(setMessage({
        message: 'Please enter at least one field to update',
        type: 'error'
      }));
    ...
    <AdminLayout>
      <div className="max-w-7xl mx-auto p-6">
        ...
        {loadingStatus === 'loading' ? (
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mb-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Current Settings</h3>
            <div className={`grid grid-cols-1 ${activeTab === 'manager' ? 'md:grid-cols-4' : 'md:grid-cols-3'} gap-4`}>
              <div className="bg-white dark:bg-gray-700 p-3 rounded-lg shadow-sm">
                <p className="text-sm text-gray-500 dark:text-gray-400">Sales Commission</p>
                <p className="text-lg font-semibold text-gray-900 dark:text-white">
                  {formatCurrency(getCommissionValue())}
              ...
              {activeTab === 'manager' && (
                <div className="bg-white dark:bg-gray-700 p-3 rounded-lg shadow-sm">
                  <p className="text-sm text-gray-500 dark:text-gray-400">Commission from Salesman Sales</p>
                  <p className="text-lg font-semibold text-gray-900 dark:text-white">
                    {formatCurrency(currentSettings.salesmanSalesCommissionForManager)}
                  </p>
                </div>
              )}
            </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            {activeTab === 'manager' && (
              <div>
                <label htmlFor="salesmanSalesCommissionForManager" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
