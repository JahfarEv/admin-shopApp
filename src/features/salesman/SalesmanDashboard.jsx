...
// useEffect(() => {
//   console.log("salesmanData changed:", salesmanData);
// }, [salesmanData]);
...
export default function SalesmanDashboard() {
  ...
  useEffect(() => {
    console.log("Redux salesman state:", {
      data: salesmanData,
      totalShops,
      totalAmount,
      totalCommission,
  ...
  }, [salesmanData, totalShops, totalAmount, totalCommission, loading, error]);
console.log(salesmanData,'data');
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
        ...
        <button 
          className="px-4 py-2 bg-gray-600 text-white rounded hover:bg-gray-700 transition-colors mt-2"
          onClick={() => {
            localStorage.removeItem("salesmanToken");
            navigate("/salesman/login");
          }}
